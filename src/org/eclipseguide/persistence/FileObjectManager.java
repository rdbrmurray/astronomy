...
public class FileObjectManager extends ObjectManager
{
    ...
    public static ObjectManager createObjectManager(Class type)
    {
        ...
        om.setFieldMap();
        om.fps = new FilePersistenceServices(om.className);
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipseguide.persistence.ObjectManager#save(java.lang.Object,
     * int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipseguide.persistence.ObjectManager#update(java.lang.Object,
     * int)
     */
    @Override
